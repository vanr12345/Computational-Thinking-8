...
word_list = ["crate","heart","audio","laugh","state","trait","plain","apple", "brick", "candy", "dance", "eagle", "flame", "grape", "haste", "jumpy", "knack", "latch", "mango", "nesty", "orbit", "plaza", "quick", "rosey", "slate", "thump", "vivid", "waste", "yacht", "zippy"]
